    ...
    def uploadDishImage() {
        ...
        try {
            ...
            if (!dish) {
                return respond([success: false, mensaje: "Platillo no encontrado"], status: 404)
            }

            DishService.saveDishImage(dish, file)
            return respond([success: true, message: "Imagen subida correctamente"], status: 200)
        } catch (IllegalArgumentException e) {
            return respond([success: false, mensaje: e.message], status: 400)
        } catch (e) {
            return respond([success: false, mensaje: "Error al subir imagen: ${e.message}"], status: 500)
        }
    }
    ...
    def downloadDishImage() {
        ...
        try {
            ...
            return respond([success: false, mensaje: "Error al descargar imagen: ${e.message}"], status: 500)
        }
    }
    ...
    def deleteDishImage() {
        ...
        try {
            ...
            return respond([success: false, mensaje: "Error al eliminar imagen: ${e.message}"], status: 500)
        }
    }
