...
class ShoppingCartController {
    ...
    def getCartByUser(){
        ...
        if (!auth.id) {
            Log.logger(Log.INFO, logId, "Consultar ordenes.", "No se ha iniciado sesion.", "params: $params")
    ...
    def editStatusShoppingCart(){
        ...
        if(!request.JSON.orderTime && data.status=="Finished"){
            Log.logger(Log.ERROR, logId, "Editar estatus del carrito.", "No se ingreso el horario en la orden.", "json: $data")
