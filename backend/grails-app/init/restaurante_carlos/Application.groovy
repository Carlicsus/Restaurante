...
class Application extends GrailsAutoConfiguration implements EnvironmentAware {
    ...
    void setEnvironment(Environment environment) {        
        ...
        def profilePaths = [
            development: "./b-cocina-v1.properties",
            stage_qa: "ruta-a-definir", // TODO: Definir ruta real para stage_qa
            production: "ruta-a-definir" // TODO: Definir ruta real para production
        ]
        ...
        if(configBase?.exists()) {
            ...
            if (config.appName) System.setProperty("appName", config.appName.toString())
